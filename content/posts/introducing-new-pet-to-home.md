...
Cats in genuine distress will stop grooming, stop eating, or start eliminating outside the litter box. Any of those within the first two weeks of an introduction is a signal to slow down. [PetMD's veterinary resource library](https://www.petmd.com/) has solid visual guides to feline stress postures if you want a reference beyond written description.
...
If you suspect a plant, product, or household item caused a reaction during the chaos of rearranging your home for a new pet, the [ASPCA Poison Control Center](https://www.aspca.org/pet-care/animal-poison-control) hotline (888-426-4435) is available 24/7. There's a consultation fee, but it's worth it to get a real toxicologist on the line fast.
...
- [ASPCA Animal Poison Control Center](https://www.aspca.org/pet-care/animal-poison-control): 24/7 toxicology hotline and pet poison reference database
- [PetMD Veterinary Resource Library](https://www.petmd.com/): Veterinarian-reviewed guides to pet behavior, stress signals, and health conditions
