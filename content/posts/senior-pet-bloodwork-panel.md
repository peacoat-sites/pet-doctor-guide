...
image: "https://images.pexels.com/photos/6285363/pexels-photo-6285363.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
...
**The chemistry panel** is where organ function lives. The main values your vet watches closely:

- **BUN and creatinine**: kidney filtration markers. SDMA is a newer, more sensitive kidney marker that can flag problems even earlier, and many senior panels now include it.
- **ALT and ALP**: liver enzymes. Elevated levels suggest liver stress or damage.
- **Glucose**: screens for diabetes, which is common in older cats and dogs.
...
## How Often Should Senior Pets Get Bloodwork Done

The general guideline, supported by [AAHA hospital accreditation standards](https://www.aaha.org/), is every six months for senior and geriatric pets. "Senior" typically starts at age 7 for dogs and cats, though large and giant breed dogs age faster and may be considered senior at 5 or 6.

I know twice-yearly testing sounds like a lot. But consider that six months in a dog's life is roughly three to four human years. A lot can change.

If your pet has already been diagnosed with kidney disease, diabetes, hyperthyroidism, Cushing's disease, or is on long-term medications like NSAIDs, steroids, or phenobarbital, your vet may want bloodwork every three months. Those drugs are hard on the liver and kidneys, and monitoring isn't optional, it's how you catch problems before they become emergencies.

For a pet with zero known issues and normal results? Annual bloodwork is reasonable until around age 10 or 11, when the every-six-months recommendation becomes more important.

---

## Reading Your Pet's Results: A Practical Breakdown

Your vet will go over results with you, but if you want to understand the printout yourself, here's a plain-language guide to the most common findings.

| Result | What It Might Mean | Next Step |
|---|---|---|
| Elevated BUN/creatinine | Reduced kidney filtration | Recheck with urinalysis, consider renal diet |
| Elevated SDMA with normal creatinine | Early kidney stress | Monitor closely, recheck in 3 months |
| High ALT | Liver cell damage or stress | Investigate cause: medications, diet, hepatic disease |
| High ALP | Liver, bone, or adrenal involvement | Context matters: age, symptoms, other values |
| Low albumin | Poor nutrition, liver disease, GI protein loss | Further workup needed |
| High glucose | Possible diabetes | Confirm with fructosamine test |
...
## How to Prepare for the Appointment and Get the Most From It
...
### My senior cat has been on hyperthyroid medication for two years. Does she still need bloodwork that often?

Yes, more than most pets actually. Methimazole (the most common hyperthyroid medication) can affect kidney and liver function, and it's important to monitor thyroid levels to make sure the dose is still right. Many hyperthyroid cats also have underlying kidney disease that only becomes apparent once the thyroid is treated. Twice-yearly bloodwork is standard, and your vet may want it quarterly while stabilizing the dose.

### The vet found slightly elevated liver enzymes but wants to "just monitor." Should I be worried?

Mildly elevated liver enzymes with no other symptoms and normal values everywhere else is genuinely often a "watch and wait" situation. That said, it's completely reasonable to ask your vet what specific threshold would prompt further investigation, and when they'd want a recheck. You should leave with a concrete timeline, not just a vague "we'll check again sometime."

### Are there toxins I should know about that could affect bloodwork values or require emergency intervention?

If your pet has gotten into something potentially toxic, the bloodwork conversation becomes urgent. The [ASPCA Poison Control Center](https://www.aspca.org/pet-care/animal-poison-control) (888-426-4435) operates 24/7 and can advise on whether emergency bloodwork is needed and what values to watch. Don't wait for symptoms with known toxin exposure.

### My dog's BUN is elevated but his creatinine is normal. Is that a problem?

BUN can be elevated for non-kidney reasons: high protein diet, dehydration, recent heavy exercise, or gastrointestinal bleeding. When BUN is up but creatinine is normal, your vet will look at those factors first. If SDMA is normal too, it's usually not a kidney alarm. A urinalysis helps clarify the picture significantly.

### Can I skip the panel this year if my pet just had surgery six months ago and was tested then?

It depends on what was tested. Surgical pre-anesthetic panels often check fewer values than a comprehensive senior wellness panel. Review what was actually run, and ask your vet if anything was omitted, like thyroid, urinalysis, or SDMA. If it was genuinely comprehensive and everything was normal, your vet may be comfortable extending the interval slightly, but get that call explicitly rather than assuming.
