---
title: "Mange in Dogs: 2 Types, Symptoms, and Treatment Options"
date: 2026-08-07T18:06:09.458522+00:00
draft: false
description: "Learn about the two main types of mange in dogs, their symptoms, and effective treatment approaches to help your pet recover."
image: "/img/heroes/37836877.jpg"
categories: ["Skin Conditions"]
tags: ["mange", "dogs", "types"]
...
slug: "mange-in-dogs-types"
affiliate_disclosure: true
faqs:
  - q: "Can my other dog catch demodectic mange?"
    a: "No. Demodex mites are not contagious between dogs, other pets, or people. They're part of normal canine skin flora that only becomes problematic when immunity is compromised. You don't need to separate your dogs if one has a Demodex diagnosis."
  - q: "How do I know if it's mange or something else?"
    a: "The pattern and location of hair loss matter. Mange tends to start at the ear margins, elbows, and face (for both types). Ringworm, allergies, and folliculitis can look similar. A skin scraping at the vet is the right first step. If the scraping is negative but the itch is severe, ask your vet about treating empirically for sarcoptic mange before assuming it's something else."
  - q: "Is mange curable?"
    a: "Sarcoptic mange: yes, fully curable with appropriate treatment in most cases. Localized demodectic mange in puppies: usually resolves on its own. Generalized demodicosis: curable in many cases, but if there's an underlying disease driving it, managing that condition becomes a permanent commitment."
  - q: "Can I treat mange at home without a vet?"
    a: "I understand why people try. Some over-the-counter options like lime sulfur dip are accessible. But without knowing which type of mange you're dealing with, you're guessing at treatment, and the consequences of getting it wrong (undertreating, treating the wrong thing, missing a hypothyroid dog) are real. At minimum, get a diagnosis confirmed. The skin scraping office visit is usually $50-90, and it changes everything about how you proceed."
  - q: "How long does mange treatment take to work?"
    a: "With modern isoxazolines, you'll often see noticeable improvement in itching within 2-3 weeks for sarcoptic mange. Full hair regrowth takes longer, sometimes 2-3 months, because the skin needs time to recover. Demodectic mange typically takes longer to resolve fully, 8-16 weeks depending on severity. Don't stop treatment just because the dog looks better."
---
...
You might be wondering if you're overreacting or underreacting [right now](/h5n1-in-cats-what-every-owner-must-know-right-now/). That's the position most people are in when they land on an article like this. Let me try to sort it out for you.


<div class="kt" style="margin:26px 0;padding:18px 22px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)"><div style="font-size:.72rem;font-weight:700;letter-spacing:.09em;text-transform:uppercase;color:var(--accent,#4338ca);margin-bottom:8px">Key takeaways</div><ul style="margin:0;padding-left:1.15em"><li style="margin:5px 0">There are two main types of mange in dogs: sarcoptic (contagious) and demodectic (not contagious to other pets or people).</li><li style="margin:5px 0">Sarcoptic mange causes intense itching within days; demodectic mange often causes patchy hair loss with milder itch.</li><li style="margin:5px 0">Sarcoptic mange requires treatment for all pets in the household; demodectic often resolves with targeted therapy alone.</li><li style="margin:5px 0">Both types are treatable, but demodectic mange in adult dogs can signal an underlying immune problem worth investigating.</li><li style="margin:5px 0">Most modern treatments (isoxazolines like Bravecto or Simparica) clear both types significantly faster than older dips and shampoos.</li></ul></div>
...
Demodectic mange, caused by *Demodex canis*, is a different situation entirely. Demodex mites actually live in normal [dog skin](/dog-skin-cancer-signs/) in small numbers. Every healthy dog has them. Problems arise when the mite population explodes, usually because of immune system dysfunction, stress, or genetic predisposition. Itching is milder or absent. Hair loss is more patchy and localized, at least initially. And here's the piece of information that surprises most people: demodectic mange is not contagious to other dogs, other pets, or people. You can't catch it from your dog. Sarcoptic mange is another story (more on that in a moment).
...
<style>.stat-chart{margin:28px 0;padding:18px 20px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)}.stat-chart .sc-title{font-weight:700;margin-bottom:12px;color:var(--heading,#1e293b)}.stat-chart .sc-row{display:flex;align-items:center;gap:10px;margin:7px 0}.stat-chart .sc-label{flex:0 0 34%;font-size:.85rem;color:var(--muted,#475569);text-align:right;overflow-wrap:anywhere}.stat-chart .sc-track{flex:1;background:var(--border,#e7e5e4);border-radius:6px;height:14px;overflow:hidden}.stat-chart .sc-bar{display:block;height:100%;background:var(--accent,#4338ca);border-radius:6px}.stat-chart .sc-val{flex:0 0 auto;font-size:.82rem;font-weight:600;color:var(--heading,#1e293b);min-width:56px}.stat-chart .sc-src{margin-top:10px;font-size:.75rem;color:var(--muted,#64748b)}@media(max-width:560px){.stat-chart .sc-label{flex-basis:42%}}</style><div class="stat-chart"><div class="sc-title">Typical treatment duration (weeks) by mange type and therapy</div><div class="sc-row"><span class="sc-label">Lime sulfur dip (sarcoptic)</span><span class="sc-track"><span class="sc-bar" style="width:80%"></span></span><span class="sc-val">8 weeks</span></div><div class="sc-row"><span class="sc-label">Amitraz dip (demodectic)</span><span class="sc-track"><span class="sc-bar" style="width:100%"></span></span><span class="sc-val">10 weeks</span></div><div class="sc-row"><span class="sc-label">Ivermectin oral (demodectic)</span><span class="sc-track"><span class="sc-bar" style="width:100%"></span></span><span class="sc-val">10 weeks</span></div><div class="sc-row"><span class="sc-label">Fluralaner/Bravecto (sarcoptic)</span><span class="sc-track"><span class="sc-bar" style="width:40%"></span></span><span class="sc-val">4 weeks</span></div><div class="sc-row"><span class="sc-label">Fluralaner/Bravecto (demodectic)</span><span class="sc-track"><span class="sc-bar" style="width:60%"></span></span><span class="sc-val">6 weeks</span></div><div class="sc-src">Source: Merck Veterinary Manual &amp; clinical practice data, 2026</div></div>
...
- [Companion Animal Parasite Council (CAPC)](https://capcvet.org/): Guidelines on ectoparasites including sarcoptic and demodectic mites, mite life cycle data.
- [Merck Veterinary Manual](https://www.merckvetmanual.com/): Clinical criteria for localized vs. generalized demodicosis, treatment protocols, breed predispositions.
- [PetMD Veterinary Resource Library](https://www.petmd.com/): Environmental survival data for *Sarcoptes scabiei*, owner-facing clinical guidance.
