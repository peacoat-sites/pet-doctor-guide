---
title: "Cat Upper Respiratory Infection"
...
Calicivirus is a different animal. It tends to cause more pronounced mouth ulcers and joint pain (yes, joint pain in cats, which manifests as a sudden reluctance to move or jump). It can also mutate into a much more severe systemic form, though that's relatively rare.

Beyond those two, Bordetella bronchiseptica and Chlamydophila felis account for a smaller share of cases, and Mycoplasma shows up as a co-infection more often than people realize. The [American Veterinary Medical Association (AVMA)](https://www.avma.org/) notes that multi-pathogen infections are common, especially in shelter or multi-cat environments, which is part of why "just a cold" can spiral unexpectedly.
...
If it's just sneezing, mild clear nasal discharge, and your cat is still eating and drinking, you've probably got 48 hours to watch and wait. Keep the environment warm, run a humidifier near where they sleep, and gently wipe discharge from the face with a warm damp cloth. [PetMD's veterinary resource library](https://www.petmd.com/) has a solid breakdown of symptom progression that's worth bookmarking for reference.
...
L-lysine supplements were recommended for years to suppress FHV-1 replication. I'll be honest about where the research landed: mixed at best. A well-designed meta-analysis basically concluded that lysine supplementation in cats is not supported by evidence. Most university hospitals have quietly moved away from recommending it. If your older vet still suggests it, it's not harmful, just probably not doing much.

## Nursing a Sick Cat at Home

Getting a congested cat to eat is often the whole battle. Warming wet food to just above room temperature intensifies the smell and usually breaks through even significant nasal congestion. Strong-smelling foods help too: tuna-flavored anything, or a tiny amount of low-sodium chicken broth drizzled over food.
...
If you don't already have a basic pet first aid kit, it's worth keeping one around, not necessarily for a URI itself, but for all the minor things that come up between vet visits. Something like the [RC Pet Products First Aid Kit](https://www.amazon.com/s?k=pet+first+aid+kit+cat&tag=yourtag-20) (Amazon link, site may earn a commission) is a reasonable starting point.
...
*Photo: [Aleksandr Nadyojin](https://www.pexels.com/@aleksandr-nadyojin-2954845) via Pexels*
