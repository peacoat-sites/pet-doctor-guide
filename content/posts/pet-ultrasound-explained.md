...
faqs:
  - q: "Is a pet ultrasound safe?"
    a: "Yes. Diagnostic ultrasound uses sound waves, not radiation, so there's no cumulative exposure risk. It's considered safe for pregnant animals, newborns, and pets undergoing repeated monitoring for chronic conditions. The procedure itself is non-invasive, and the gel and probe cause no discomfort beyond mild pressure."
  - q: "Does my pet need to be sedated for an ultrasound?"
    a: "Not necessarily. Many dogs and cats lie still well enough for a good quality scan without any sedation. Animals that are painful, highly anxious, or that need a guided biopsy or aspirate are more likely to receive a short-acting sedative. Your vet will assess this on the day based on your pet's temperament and what the scan involves."
  - q: "How is a pet ultrasound different from an MRI?"
    a: "Both provide detailed soft tissue imaging, but they work very differently. Ultrasound uses sound waves and is real-time, relatively affordable, and widely available. MRI uses magnetic fields and radio waves to create cross-sectional images with extraordinary tissue detail, but it requires full general anesthesia, specialized facilities, and significantly higher cost. MRI is more commonly used for neurological conditions like spinal cord disease or brain lesions. Your vet will recommend the appropriate tool based on what they're trying to see."
  - q: "What if the ultrasound doesn't find anything?"
...
| When the AAHA standard matters | General practice hospitals meeting [AAHA accreditation standards](https://www.aaha.org/) follow stricter equipment and protocol guidelines | Specialists follow their own board certification standards |
...
Yes. Diagnostic ultrasound uses sound waves, not radiation, so there's no cumulative exposure risk. It's considered safe for pregnant animals, newborns, and pets undergoing repeated monitoring for chronic conditions. The procedure itself is non-invasive, and the gel and probe cause no discomfort beyond mild pressure.

### Does my pet need to be sedated for an ultrasound?

Not necessarily. Many dogs and cats lie still well enough for a good quality scan without any sedation. Animals that are painful, highly anxious, or that need a guided biopsy or aspirate are more likely to receive a short-acting sedative. Your vet will assess this on the day based on your pet's temperament and what the scan involves.

### How is a pet ultrasound different from an MRI?

Both provide detailed soft tissue imaging, but they work very differently. Ultrasound uses sound waves and is real-time, relatively affordable, and widely available. MRI uses magnetic fields and radio waves to create cross-sectional images with extraordinary tissue detail, but it requires full general anesthesia, specialized facilities, and significantly higher cost. MRI is more commonly used for neurological conditions like spinal cord disease or brain lesions. Your vet will recommend the appropriate tool based on what they're trying to see.

### What if the ultrasound doesn't find anything?

A normal ultrasound is genuinely good news, even when you're still worried about your pet's symptoms. It rules out a significant list of serious conditions. If symptoms persist after a normal scan, your vet will likely consider other diagnostics. A clean ultrasound narrows the field considerably and that's valuable information, not wasted effort.

### How do I know if my pet needs an ultrasound urgently?

Some situations call for same-day emergency imaging. These include a distended or painful abdomen, suspected internal bleeding after trauma, collapse or sudden weakness, or a male cat that hasn't urinated. If your pet is showing any of these signs, call your vet or an emergency clinic immediately rather than waiting for a scheduled appointment. When in doubt, call first and describe what you're seeing.
