...
The [ASPCA Poison Control Center](https://www.aspca.org/pet-care/animal-poison-control) has a toxin helpline, but for a hypoglycemic crisis, your nearest 24-hour emergency vet is your resource.
...
- [American Association of Feline Practitioners Diabetes Management Guidelines](https://catvets.com/): Evidence-based protocols for insulin selection, dosing, and monitoring in diabetic cats.
- [Roomp K, Rand J. "Intensive blood glucose control is safe and effective in diabetic cats using home monitoring and treatment with glargine." Journal of Feline Medicine and Surgery, 2009](https://journals.sagepub.com/): Landmark research supporting glargine use and remission potential in cats.
- [PetMD Veterinary Resource Library](https://www.petmd.com/): Accessible breakdowns of feline diabetes, insulin types, and home monitoring protocols reviewed by veterinarians.
- [AlphaTrak 3 Veterinary Glucose Monitor (Zoetis)](https://www.zoetisus.com/): Product documentation and clinical validation for at-home feline/canine glucose testing.
- [Cornell Feline Health Center: Diabetes Mellitus](https://www.vet.cornell.edu/departments-centers-and-institutes/cornell-feline-health-center): Solid owner-facing overview of diagnosis, management, and what to watch for.
