...
slug: "distemper-in-dogs"
affiliate_disclosure: true
faqs:
  - q: "Can a vaccinated dog get distemper?"
    a: "It's uncommon but not impossible. No vaccine is 100% effective in 100% of individuals. Immune response varies, and a dog who received only one puppy shot or missed booster timing may have inadequate protection. In my clinical experience, distemper in vaccinated dogs who completed the proper series is extremely rare, and when it does occur, the illness tends to be less severe."
  - q: "How long does distemper virus survive in the environment?"
    a: "Distemper virus is relatively fragile outside a host. At room temperature it typically survives only a few hours, and it's easily inactivated by standard disinfectants. Unlike parvovirus, which can survive for months in soil, distemper isn't something you're bringing home on your shoes. Direct contact with infected animals is the main concern."
  - q: "What are the first signs of distemper I should watch for?"
    a: "Early signs look a lot like a respiratory infection: nasal discharge (often thick and yellow-green rather than clear), eye discharge, coughing, lethargy, and fever. The problem is that these signs overlap with kennel cough and several other common illnesses. If your dog is unvaccinated or has incomplete vaccine history and shows these signs, don't wait to see if it resolves. Get to a vet for testing."
  - q: "Is distemper contagious to humans or cats?"
...
- [American Veterinary Medical Association (AVMA)](https://www.avma.org/): Core vaccine guidelines and canine distemper disease overview
- [PetMD Veterinary Resource Library](https://www.petmd.com/): Canine distemper clinical overview and vaccination history
