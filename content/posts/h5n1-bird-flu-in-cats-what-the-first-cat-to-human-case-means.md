---
title: "H5N1 Bird Flu in Cats: What the First Cat-to-Human Case Means"
date: 2026-07-15T18:34:44.643227+00:00
draft: false
description: "Learn about the first confirmed H5N1 bird flu case in cats and what it means for human transmission risk. Expert insights on prevention and safety measures."
image: "/img/heroes/11497474.jpg"
categories: ["trending"]
tags: ["h5n1", "bird", "cats:", "what", "first"]
author: "Karen Lopez"
...
<div class="kt" style="margin:26px 0;padding:18px 22px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)"><div style="font-size:.72rem;font-weight:700;letter-spacing:.09em;text-transform:uppercase;color:var(--accent,#4338ca);margin-bottom:8px">Key takeaways</div><ul style="margin:0;padding-left:1.15em"><li style="margin:5px 0">The first confirmed cat-to-human H5N1 transmission was documented by the CDC on May 7, 2026, in Los Angeles.</li><li style="margin:5px 0">14 of 19 exposed cats in the LA cluster died; all had eaten commercially purchased raw animal products.</li><li style="margin:5px 0">Only 1 of 25 exposed humans tested positive, but that person performed unprotected high-exposure procedures.</li><li style="margin:5px 0">H5N1 has been confirmed in cats across 18 countries; over half of infected cats have died.</li><li style="margin:5px 0">No H5N1 vaccine is currently available for domestic cats.</li></ul></div>
...
I've had this conversation with clients more times than I can count over the past year and a half. Someone comes in with a sick cat and mentions they feed raw. I'm not here to debate the raw feeding community, but the LA cluster should settle at least one question: contaminated [raw pet food](/raw-pet-food-recalls-are-piling-up-what-owners-need-to-know/) is a real, documented route for H5N1 to reach your cat.
...
- [CDC MMWR: Serologic Evidence of H5N1 Infection in a Veterinary Professional Exposed to an Infected Domestic Cat](https://www.cdc.gov/mmwr/volumes/75/wr/mm7517a1.htm) (May 7, 2026)
- [dvm360: Weekly Vet Report ,  Cat-to-Human Bird Flu Transmission](https://www.dvm360.com/view/weekly-vet-report-cat-to-human-bird-flu-transmission-new-injectable-for-itchy-dogs-major-pet-food-recall) (May 29, 2026)
...
- [Worms & Germs Blog: Cat-to-Human Transmission of H5N1 Influenza](https://www.wormsandgermsblog.com/2026/05/articles/animals/cats/cat-to-human-transmission-of-h5n1/) (May 7, 2026)
...
- [dvm360: 2026 AVMA Convention Sessions Guide (H5N1 in Cats Panel)](https://www.dvm360.com/view/dvm360-guide-to-2026-avma-convention-sessions-worth-your-time-in-anaheim) (July 13, 2026)

*Photo: [Anatolii Maks](https://www.pexels.com/@anatolii-maksymov) via Pexels*
