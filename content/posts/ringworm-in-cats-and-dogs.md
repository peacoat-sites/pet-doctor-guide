---
title: "Ringworm in Cats and Dogs: Signs, Treatment, and Prevention"
date: 2026-07-23T18:40:27.659237+00:00
draft: false
description: "Learn how to identify ringworm in cats and dogs, treat fungal infections effectively, and prevent spread to other pets and family members."
image: "/img/heroes/21579851.jpg"
categories: ["Skin Conditions"]
tags: ["ringworm", "cats", "dogs"]
...
slug: "ringworm-in-cats-and-dogs"
affiliate_disclosure: true
faqs:
  - q: "Is ringworm contagious to humans from cats and dogs?"
    a: "Yes, it's a zoonotic infection. Direct contact with an infected animal or contaminated surfaces can transmit it to people. Children, elderly individuals, and immunocompromised people are at highest risk. Wash hands thoroughly after handling an infected pet and avoid letting them sleep in your bed during treatment."
  - q: "How long does ringworm treatment take in cats and dogs?"
    a: "Expect 6 to 12 weeks for a full treatment course. The biggest mistake owners make is stopping when lesions look healed, usually around week four. Continue until your vet confirms two consecutive negative fungal cultures, typically taken two to four weeks apart."
  - q: "Can ringworm go away on its own without treatment?"
    a: "Technically, healthy adult animals with robust immune systems can sometimes clear ringworm without treatment over several months. In practice, this isn't a reasonable strategy: the animal remains contagious the entire time, spores accumulate in the environment, and other pets and people in the household are at ongoing risk."
  - q: "How do I tell if my cat has ringworm or something else?"
    a: "You can't reliably tell by looking. Classic circular hair loss with a scaly border is suggestive but not diagnostic, and ringworm can mimic mange, bacterial folliculitis, and other skin conditions. A fungal culture (DTM) from your vet is the only way to confirm it."
  - q: "What cleaning products kill ringworm spores?"
    a: "A 1:10 bleach-to-water solution is the most accessible effective option for hard surfaces. Accelerated hydrogen peroxide products (such as Rescue disinfectant, which specifies kill claims for dermatophytes on the label) also work. Standard household cleaners and most disinfectant sprays without specific antifungal labeling are not reliable against fungal spores. Carpets and porous materials are genuinely hard to decontaminate; restriction to hard-floored areas during active infection is the most practical approach."
---

Ringworm is one of those diagnoses that makes [pet owners](/new-world-screwworm-is-back-in-the-us-what-pet-owners-must-know/) visibly relax when I say the name, because it sounds manageable. Then I tell them it's a fungal infection that can live on surfaces in their home for 18 months and spreads readily to humans, and the relaxation disappears fast.
...
<div class="kt" style="margin:26px 0;padding:18px 22px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)"><div style="font-size:.72rem;font-weight:700;letter-spacing:.09em;text-transform:uppercase;color:var(--accent,#4338ca);margin-bottom:8px">Key takeaways</div><ul style="margin:0;padding-left:1.15em"><li style="margin:5px 0">Ringworm is caused by a fungus (usually Trichophyton or Microsporum), not a worm.</li><li style="margin:5px 0">Cats are far more commonly infected than dogs; longhaired breeds and kittens under 1 year are highest risk.</li><li style="margin:5px 0">Treatment typically runs 6-12 weeks; stopping early is the single most common reason it comes back.</li><li style="margin:5px 0">Environmental decontamination is non-negotiable, the fungus survives on surfaces for up to 18 months.</li><li style="margin:5px 0">It's a zoonotic infection: you, your kids, and other pets in the home can all contract it.</li></ul></div>
...
Here's where most articles fail you: they describe the classic textbook lesion, a neat circular patch of hair loss with a slightly red, scaly ring. That does happen. It's also not always what you see.
...
There's no shortcut here. Ringworm treatment is a commitment.
...
| Treatment Component | Options | Frequency | Notes |
|---|---|---|---|
| Systemic antifungal | Itraconazole, terbinafine, griseofulvin | Daily or every other day (varies) | 6-12 weeks typical; stop based on culture, not appearance |
| Topical dip | Lime sulfur solution (1:32 dilution) | Twice weekly | Most effective option; strong odor, stains surfaces |
| Topical shampoo | Miconazole/chlorhexidine (e.g., Malaseb) | Twice weekly, 5-10 min contact time | More practical for long-term use; less potent than lime sulfur |
| Environmental cleaning | Diluted bleach (1:10), antifungal surface sprays | Daily to every few days | Carpets and porous surfaces are the hardest to decontaminate |
| Monitoring | Fungal culture (DTM) | Every 2-4 weeks | Two consecutive negatives before stopping treatment |
...
If you have multiple pets, isolating the infected individual matters. Healthy adult cats and dogs with intact immune systems often resist infection, but kittens, elderly animals, and immunocompromised [pets are](/new-world-screwworm-is-back-in-the-us-and-pets-are-at-risk/) at real risk. Test and culture all animals in the household regardless of symptoms.
...
If anyone in your household develops a suspicious skin lesion during treatment of your pet, see a doctor. [PetMD's veterinary resource library](https://www.petmd.com/) has a solid overview of ringworm transmission dynamics if you want the full picture on risk factors for household spread.
...
<style>.stat-chart{margin:28px 0;padding:18px 20px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)}.stat-chart .sc-title{font-weight:700;margin-bottom:12px;color:var(--heading,#1e293b)}.stat-chart .sc-row{display:flex;align-items:center;gap:10px;margin:7px 0}.stat-chart .sc-label{flex:0 0 34%;font-size:.85rem;color:var(--muted,#475569);text-align:right;overflow-wrap:anywhere}.stat-chart .sc-track{flex:1;background:var(--border,#e7e5e4);border-radius:6px;height:14px;overflow:hidden}.stat-chart .sc-bar{display:block;height:100%;background:var(--accent,#4338ca);border-radius:6px}.stat-chart .sc-val{flex:0 0 auto;font-size:.82rem;font-weight:600;color:var(--heading,#1e293b);min-width:56px}.stat-chart .sc-src{margin-top:10px;font-size:.75rem;color:var(--muted,#64748b)}@media(max-width:560px){.stat-chart .sc-label{flex-basis:42%}}</style><div class="stat-chart"><div class="sc-title">Estimated ringworm treatment cost by scenario</div><div class="sc-row"><span class="sc-label">Single pet, caught early</span><span class="sc-track"><span class="sc-bar" style="width:29%"></span></span><span class="sc-val">$280</span></div><div class="sc-row"><span class="sc-label">Single pet, delayed diagnosis</span><span class="sc-track"><span class="sc-bar" style="width:51%"></span></span><span class="sc-val">$480</span></div><div class="sc-row"><span class="sc-label">Multi-pet household, all treated</span><span class="sc-track"><span class="sc-bar" style="width:76%"></span></span><span class="sc-val">$720</span></div><div class="sc-row"><span class="sc-label">Multi-pet + human infection</span><span class="sc-track"><span class="sc-bar" style="width:100%"></span></span><span class="sc-val">$950</span></div><div class="sc-src">Source: Clinical experience, typical small animal practice pricing, 2026</div></div>


## Sources

- [American Veterinary Medical Association (AVMA)](https://www.avma.org/): Dermatophytosis guidelines and zoonotic disease fact sheets
- [Moriello KA, et al. (2017), Veterinary Dermatology](https://onlinelibrary.wiley.com/journal/13653164): "Diagnosis and treatment of dermatophytosis in dogs and cats" -- the current clinical consensus paper, still the most-cited reference in this area
- [PetMD veterinary resource library](https://www.petmd.com/): Ringworm transmission and household management overview, reviewed by licensed veterinarians
- [Sparkes AH, et al., Journal of Small Animal Practice](https://onlinelibrary.wiley.com/journal/17485827): Studies on itraconazole pharmacokinetics in cats and treatment duration
- [Cornell Feline Health Center](https://www.vet.cornell.edu/departments-centers-and-institutes/cornell-feline-health-center): Practical feline ringworm resources with shelter-specific protocols
