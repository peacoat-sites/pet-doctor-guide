---
title: "Glaucoma in Dogs: Early Signs and Treatment Options"
date: 2026-07-24T18:51:58.503174+00:00
draft: false
description: "Learn how to recognize glaucoma symptoms in dogs and understand treatment approaches to protect your pet's vision and eye health."
image: "/img/heroes/24595746.jpg"
...
slug: "glaucoma-in-dogs"
affiliate_disclosure: true
faqs:
  - q: "How quickly can a dog go blind from glaucoma?"
    a: "Irreversible vision loss can occur within 24 to 72 hours when intraocular pressure exceeds 40 mmHg. This is why acute glaucoma is treated as an emergency, not a 'wait and see' situation."
  - q: "Can glaucoma in dogs be cured?"
    a: "Primary glaucoma cannot be cured. Surgery and medication manage pressure and slow progression, but the underlying drainage dysfunction remains. Secondary glaucoma sometimes resolves if the root cause (like lens luxation) is treated successfully."
  - q: "Is my dog in pain with glaucoma?"
    a: "Almost certainly yes, especially in acute cases. Elevated intraocular pressure causes a headache-like pain that can be severe. Dogs may show it through lethargy, reduced appetite, face rubbing, or general behavioral changes rather than obvious eye-pawing."
  - q: "Should I see a specialist, or is my regular vet enough?"
    a: "Your regular vet can handle initial diagnosis and emergency pressure reduction. For long-term management, surgical options, or gonioscopy to assess the drainage angle, a veterinary ophthalmologist is the right call. Most general practitioners will refer proactively."
  - q: "What does glaucoma look like in a dog's eye?"
    a: "Early signs include redness, squinting, and slight corneal cloudiness. As it progresses, the eye may appear visibly larger than the other eye (buphthalmos), the cornea may turn blue-gray, and the pupil may be dilated and unresponsive to light."
---
...
<div class="kt" style="margin:26px 0;padding:18px 22px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)"><div style="font-size:.72rem;font-weight:700;letter-spacing:.09em;text-transform:uppercase;color:var(--accent,#4338ca);margin-bottom:8px">Key takeaways</div><ul style="margin:0;padding-left:1.15em"><li style="margin:5px 0">Intraocular pressure above 30 mmHg is an emergency; vision loss can occur within hours.</li><li style="margin:5px 0">Cocker Spaniels, Basset Hounds, and Shiba Inus face the highest inherited glaucoma risk.</li><li style="margin:5px 0">The earliest signs are subtle: squinting, a slightly enlarged eye, or redness that doesn't resolve in 24 hours.</li><li style="margin:5px 0">Primary glaucoma is genetic; secondary glaucoma follows another disease like uveitis or lens luxation.</li><li style="margin:5px 0">Surgery or long-term medication can preserve quality of life, but neither reverses vision already lost.</li></ul></div>
...
| Treatment Option | Best For | Cost Range (2026) | Realistic Goal |
|---|---|---|---|
| Topical dorzolamide/timolol (Cosopt equivalent) | Early/mild cases, prophylaxis in fellow eye | $40-$90/month | Pressure control, not cure |
| Oral carbonic anhydrase inhibitors (methazolamide) | Adjunct therapy, acute crisis | $30-$60/month | Short-term pressure reduction |
| Laser cyclophotocoagulation | Dogs with remaining vision | $1,800-$3,500 per eye | Reduce fluid production |
| Gonioimplant/drainage device | Dogs with vision, moderate to high pressure | $2,200-$4,000 per eye | Long-term drainage |
| Pharmacologic ablation (gentamicin injection) | Blind, painful eye without surgery | $300-$600 | Pain relief only |
| Enucleation | Blind, chronically painful eye | $800-$1,800 | Definitive pain relief |

The pharmacologic ablation option is one I don't see discussed enough in online pet health resources. Injecting gentamicin into a blind, painful eye destroys the ciliary body's ability to produce fluid, which relieves pressure and pain without removing the eye. The cosmetics aren't perfect afterward, but many owners prefer it over enucleation. [PetMD's veterinary resource library](https://www.petmd.com/) has a decent overview of it if you want to read more before your consult.
...
<style>.stat-chart{margin:28px 0;padding:18px 20px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)}.stat-chart .sc-title{font-weight:700;margin-bottom:12px;color:var(--heading,#1e293b)}.stat-chart .sc-row{display:flex;align-items:center;gap:10px;margin:7px 0}.stat-chart .sc-label{flex:0 0 34%;font-size:.85rem;color:var(--muted,#475569);text-align:right;overflow-wrap:anywhere}.stat-chart .sc-track{flex:1;background:var(--border,#e7e5e4);border-radius:6px;height:14px;overflow:hidden}.stat-chart .sc-bar{display:block;height:100%;background:var(--accent,#4338ca);border-radius:6px}.stat-chart .sc-val{flex:0 0 auto;font-size:.82rem;font-weight:600;color:var(--heading,#1e293b);min-width:56px}.stat-chart .sc-src{margin-top:10px;font-size:.75rem;color:var(--muted,#64748b)}@media(max-width:560px){.stat-chart .sc-label{flex-basis:42%}}</style><div class="stat-chart"><div class="sc-title">Fellow Eye Glaucoma Risk by Month (Untreated)</div><div class="sc-row"><span class="sc-label">Month 1</span><span class="sc-track"><span class="sc-bar" style="width:12%"></span></span><span class="sc-val">8%</span></div><div class="sc-row"><span class="sc-label">Month 3</span><span class="sc-track"><span class="sc-bar" style="width:34%"></span></span><span class="sc-val">22%</span></div><div class="sc-row"><span class="sc-label">Month 6</span><span class="sc-track"><span class="sc-bar" style="width:58%"></span></span><span class="sc-val">38%</span></div><div class="sc-row"><span class="sc-label">Month 8</span><span class="sc-track"><span class="sc-bar" style="width:80%"></span></span><span class="sc-val">52%</span></div><div class="sc-row"><span class="sc-label">Month 12</span><span class="sc-track"><span class="sc-bar" style="width:100%"></span></span><span class="sc-val">65%</span></div><div class="sc-src">Source: Veterinary ophthalmology studies, compiled 2026</div></div>
...
If you're managing costs, a [pet first aid kit](https://www.amazon.com/s?k=pet+first+aid+kit) with a symptom log and medication tracker is genuinely useful for chronic disease management (disclosure: this site may earn a commission on purchases). Write down every IOP reading at every visit. Trends matter more than single numbers, and you'll be glad you have the data when you're three ophthalmologists and two emergencies in.

## Sources

- [American College of Veterinary Ophthalmologists (ACVO)](https://www.acvo.org/): Breed screening recommendations and glaucoma position statements
...
- [PetMD Veterinary Resource Library](https://www.petmd.com/): Clinical overviews of glaucoma treatments including pharmacologic ablation
...
- [ASPCA Animal Poison Control Center](https://www.aspca.org/pet-care/animal-poison-control): Drug interaction guidance for pets on multiple medications

---


*Photo: [William Prado](https://www.pexels.com/@william-prado-1302103031) via Pexels*
