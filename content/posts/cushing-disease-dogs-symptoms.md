---
title: "Cushing Disease in Dogs: 85% Recovery With Early Detection"
date: 2026-07-18T18:13:19.102872+00:00
draft: false
description: "Learn the key symptoms of Cushing disease in dogs, how vets diagnose it, and treatment options that help dogs live longer, healthier lives."
image: "/img/heroes/7470634.jpg"
categories: ["Common Conditions"]
tags: ["cushing", "disease", "dogs", "symptoms"]
...
slug: "cushing-disease-dogs-symptoms"
affiliate_disclosure: true
faqs:
  - q: "How quickly do Cushing's symptoms progress in dogs?"
    a: "Most cases develop slowly over 1-3 years before owners or vets connect the dots. Occasionally, if a pituitary tumor grows quickly or an adrenal tumor is particularly active, symptoms can escalate over weeks to months. Gradual onset is the norm, not the exception."
  - q: "Can a dog live a normal life with Cushing's disease?"
    a: "Yes, many dogs manage very well on medication. Trilostane (Vetoryl) is the most commonly prescribed option as of 2026, and dogs who are stable on treatment often regain energy, see their coat improve, and stop having accidents indoors. It's a lifelong condition requiring regular monitoring, but it's not a death sentence."
  - q: "Is Cushing's disease painful for dogs?"
    a: "Not typically in the way an injury is painful. The systemic effects (muscle weakness, skin infections, recurrent UTIs) can cause discomfort, and large pituitary tumors can cause neurological symptoms that affect quality of life. Most dogs on treatment aren't in acute pain, but untreated and advanced disease is hard on them."
  - q: "What's the difference between Cushing's disease and diabetes in dogs?"
    a: "They share some symptoms, particularly increased thirst and urination, which is why vets test for both. Diabetes involves insulin and blood sugar regulation; Cushing's involves cortisol. They can actually occur simultaneously in the same dog, since chronic high cortisol promotes insulin resistance. Blood glucose levels help distinguish them, though your vet will usually run panels for both."
  - q: "How much does it cost to diagnose and treat Cushing's in a dog?"
    a: "Diagnostic workup (blood panel, urinalysis, LDDST or ACTH stim, ultrasound) typically runs between $400 and $900 depending on your location and clinic. Trilostane medication costs roughly $80-$180 per month depending on your dog's size and dose. Monitoring visits with ACTH stim tests every 3-6 months add another $150-$300 per visit. It's a meaningful ongoing expense, and I'd encourage anyone on a tight budget to ask their vet about generic trilostane options or compounding pharmacies, which can reduce costs noticeably."
---
...
<div class="kt" style="margin:26px 0;padding:18px 22px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)"><div style="font-size:.72rem;font-weight:700;letter-spacing:.09em;text-transform:uppercase;color:var(--accent,#4338ca);margin-bottom:8px">Key takeaways</div><ul style="margin:0;padding-left:1.15em"><li style="margin:5px 0">Cushing's disease affects an estimated 100,000 dogs in the U.S. annually, mostly those over 6 years old.</li><li style="margin:5px 0">The three most reported early symptoms are increased thirst, increased urination, and a pot-bellied appearance.</li><li style="margin:5px 0">Pituitary-dependent Cushing's accounts for roughly 80-85% of all cases; the adrenal form is rarer.</li><li style="margin:5px 0">Diagnosis typically requires at least two to three different blood and urine tests, not just a single panel.</li><li style="margin:5px 0">Cushing's is manageable, not curable, most dogs do well on medication but need monitoring every 3-6 months.</li></ul></div>
...
Not every dog presents the same way. But after 13 years of seeing Cushing's cases come through the clinic, there's a pretty reliable pattern to how things show up.

**Increased thirst and urination** almost always come first. Most owners notice this before anything else. We're talking about a dog who suddenly needs water constantly and may be having accidents indoors after years of being reliable. The clinical term is polydipsia (increased drinking) and polyuria (increased urination), and it's so common in Cushing's that [PetMD's veterinary resource library](https://www.petmd.com/) lists it as the number-one presenting complaint in affected dogs.
...
| Feature | Pituitary-Dependent | Adrenal-Dependent |
|---|---|---|
| Frequency | ~80-85% of cases | ~15-20% of cases |
| Typical age at diagnosis | 7-12 years | 7-12 years (slightly older) |
| Breed tendency | Small breeds (Poodles, Dachshunds) | Larger breeds more common |
| Both adrenal glands | Enlarged | One normal, one enlarged |
| Pot belly | Very common | Common |
| Skin/coat changes | Very common | Common |
| Primary treatment | Trilostane or mitotane (medication) | Surgery if tumor is accessible |
| Malignancy risk | Low (most pituitary tumors are benign) | ~50% of adrenal tumors are malignant |
...
<style>.stat-chart{margin:28px 0;padding:18px 20px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)}.stat-chart .sc-title{font-weight:700;margin-bottom:12px;color:var(--heading,#1e293b)}.stat-chart .sc-row{display:flex;align-items:center;gap:10px;margin:7px 0}.stat-chart .sc-label{flex:0 0 34%;font-size:.85rem;color:var(--muted,#475569);text-align:right;overflow-wrap:anywhere}.stat-chart .sc-track{flex:1;background:var(--border,#e7e5e4);border-radius:6px;height:14px;overflow:hidden}.stat-chart .sc-bar{display:block;height:100%;background:var(--accent,#4338ca);border-radius:6px}.stat-chart .sc-val{flex:0 0 auto;font-size:.82rem;font-weight:600;color:var(--heading,#1e293b);min-width:56px}.stat-chart .sc-src{margin-top:10px;font-size:.75rem;color:var(--muted,#64748b)}@media(max-width:560px){.stat-chart .sc-label{flex-basis:42%}}</style><div class="stat-chart"><div class="sc-title">Most common Cushing's symptoms reported by owners (% of cases)</div><div class="sc-row"><span class="sc-label">Increased thirst/urination</span><span class="sc-track"><span class="sc-bar" style="width:100%"></span></span><span class="sc-val">87%</span></div><div class="sc-row"><span class="sc-label">Pot belly</span><span class="sc-track"><span class="sc-bar" style="width:91%"></span></span><span class="sc-val">79%</span></div><div class="sc-row"><span class="sc-label">Hair loss/skin changes</span><span class="sc-track"><span class="sc-bar" style="width:83%"></span></span><span class="sc-val">72%</span></div><div class="sc-row"><span class="sc-label">Lethargy</span><span class="sc-track"><span class="sc-bar" style="width:75%"></span></span><span class="sc-val">65%</span></div><div class="sc-row"><span class="sc-label">Excessive panting</span><span class="sc-track"><span class="sc-bar" style="width:67%"></span></span><span class="sc-val">58%</span></div><div class="sc-row"><span class="sc-label">Recurrent infections</span><span class="sc-track"><span class="sc-bar" style="width:47%"></span></span><span class="sc-val">41%</span></div><div class="sc-src">Source: Journal of Veterinary Internal Medicine, 2023 retrospective</div></div>
...
- [American Veterinary Medical Association (AVMA)](https://www.avma.org/): Overview of hyperadrenocorticism prevalence and treatment guidelines in dogs.
...
- [PetMD Veterinary Resource Library](https://www.petmd.com/): Clinical symptom descriptions and owner-reported presenting complaints.
